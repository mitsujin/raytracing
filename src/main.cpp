...
int main()
{
    ...
    world.Add(std::make_unique<Sphere>(Vector3(-1.0, 0.0, -1.0f), 0.5f, std::make_unique<Dielectric>(1.5f)));
    world.Add(std::make_unique<Sphere>(Vector3(-1.0, 0.0, -1.0f), -0.45f, std::make_unique<Dielectric>(1.5f)));
